...
Original file is located at
    https://colab.research.google.com/drive/1nIL9feXMsc_Qb7d-rWvBszFwogGBm0pe
"""
...
root_directory = '/content/drive/MyDrive/archive (2)/Semantic segmentation dataset'
...
pip install --upgrade simple_multi_unet_model

pip install simple_multi_unet_model
...
from keras_unet.models import multi_unet_model, jacard_coef
...
model = get_model()
# loss_f1=keras.losses.SparseCategoricalCrossentropy()
model.compile(optimizer='adam', loss='mean_squared_error', metrics=tf.keras.metrics.AUC())
